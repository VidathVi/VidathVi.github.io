      ...
      <div className="space-y-4">
        {certificatesData.map((cert) => (
          ...
          >
            ...
            <div 
              className="relative w-full sm:w-48 shrink-0 aspect-16/10 sm:aspect-auto sm:h-auto bg-gray-100 overflow-hidden group/media flex items-center justify-center border-b sm:border-b-0 sm:border-r border-gray-100"
            >
              {cert.type === 'image' ? (
                <>
                  <img
            ...
            <div className="p-5 space-y-3 flex-1 flex flex-col justify-center">
              <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-2">
                ...
                {cert.date && (
                  <span className="text-xs text-gray-400 font-medium sm:text-right shrink-0">{cert.date}</span>
                )}
              </div>

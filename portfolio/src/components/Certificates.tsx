    ...
    <section id="certificates" className="space-y-6 pt-16 border-t border-white/20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {certificatesData.map((cert) => (
          <div
            key={cert.id}
            className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden flex flex-col justify-between hover:shadow-md transition-all duration-200 group"
          >
            <div>
              {/* Media Preview Container */}
              <div 
                className="relative aspect-16/10 bg-gray-100 overflow-hidden cursor-pointer group/media flex items-center justify-center border-b border-gray-100"
            ...
            <div className="p-5 pt-0 flex items-center gap-2">
              <button
                onClick={() => setActiveCertificate(cert)}
                className="flex-1 text-center py-2 px-3 bg-gray-100 hover:bg-gray-200 text-gray-800 text-xs font-semibold rounded-lg transition-colors flex items-center justify-center gap-1.5"
              >
                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
              ...
              <a
                href={cert.fileUrl}
                download
                className="py-2 px-3 bg-[#284bbe]/10 hover:bg-[#284bbe]/20 text-[#284bbe] text-xs font-semibold rounded-lg transition-colors flex items-center justify-center gap-1.5"
